...
excerpt: "I have been blogging since 2013 and for most of the time I have been on WordPress. But, I am migrating my site over to Gatsby. What motivated the change and what has the migration process been so far. Let's find out."
categories:
    - Uncategorized
tags:
    - 'gatsby'
...
-   Degraded Experience for my style
...
Just when it seemed that I would have to resign myself to use Github Pages, I found out about [Gatsby](https://gatsbyjs.org) which is based on Javascript. I have been using Typescript increasingly at work so this seemed like the perfect solution. It's also not difficult to move your blog from Wordpress to Gatsby. I will give you the basics of what I did in case you also want to make the switch.

But first, Let's see how it stacks up against my concerns from the previous section
...
-   Use the [ExitWP](https://github.com/thomasf/exitwp) or [Wordpress-to-Hugo](https://github.com/SchumacherFM/wordpress-to-hugo-exporter) tool to convert the XML to markdown.
