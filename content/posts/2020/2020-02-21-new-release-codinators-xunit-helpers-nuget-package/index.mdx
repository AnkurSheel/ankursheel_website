...
The 1st Release adds support for loading test data from a JSON file for xUnit Tests as outlined in the article [How to load test data from a json file for xUnit tests](./load-test-data-from-a-json-file-for-xunit-tests).
