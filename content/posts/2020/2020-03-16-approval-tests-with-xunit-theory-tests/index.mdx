...
In the above snippet, the filename generated for both the tests will be **_TestClass.Test.approved.txt_**. This means that you have only 1 approval file for both the tests.
