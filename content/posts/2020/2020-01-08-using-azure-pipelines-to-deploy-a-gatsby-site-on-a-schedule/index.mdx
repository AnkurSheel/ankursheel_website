...
In an [earlier post](../deploying-a-gatsby-site-to-netlify-using-azure-pipelines), I showed how to use azure pipelines
to build a gatsby site and deploy to netlify. But it was slightly limited. A live build was deployed only when a push
was made to _master_. There was no way to have scheduled posts go live automatically.
