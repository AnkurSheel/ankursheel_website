...
excerpt: 'How we can deploy our gatsby site to netlify on a daily basis and have scheduled posts automatically go live by triggering Azure pipelines on a schedule'
