...
~~The build-vs-buy debate is an interesting one and most tech companies will err on the side of build. **Nočnica Fee** explains the short-sightedness of this decision by way of a story of how a company goes from "make money" to "run servers"~~.
