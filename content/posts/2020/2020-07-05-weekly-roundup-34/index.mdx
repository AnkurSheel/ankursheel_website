...
Webmention a way of letting a website know it has been mentioned somewhere, by someone, in some way. **Atila Fassina** has a [tutorial to add the feature your wesbite](https://css-tricks.com/jumping-into-webmentions-with-nextjs-or-not/). Its based off NextJs but I think it can easily be adapted to a site built with Gatsby. Now, I just need to get the time to add it to this one.
