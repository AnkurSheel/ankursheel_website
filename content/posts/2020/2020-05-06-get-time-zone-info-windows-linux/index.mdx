...
-   On Windows, they are identified by a value provided by Microsoft and takes a form such as "New Zealand Standard Time".
...
The easiest way I have found to solve this is to check if the Windows value exists in the list of time zones. If it exists, use the Windows value to get the time zone info, else use the IANA value.
