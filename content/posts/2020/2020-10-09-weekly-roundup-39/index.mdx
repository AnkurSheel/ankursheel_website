...
**Alex** demonstrates how he participated in the Do Not Get Arrested Challenge 2020 by [logging in as the former Australian Primer minister Tony Abbot on an airline website](https://mango.pdf.zone/finding-former-australian-prime-minister-tony-abbotts-passport-number-on-instagram) and getting details such as his passport id after he shared a photo of his boarding pass on Instagram. It's a long, but entertaining story.

**Jared Palmer** has an excellent [takedown of the Gatsby Framework](https://jaredpalmer.com/gatsby-vs-nextjs) and why he has moved away from Gatsby to Next.js. This blog is [built on gatsby](./migrating-from-wordpress-to-gatsby) and I have been finding it difficult to debug issues and add functionality. At least, now I know its just not me.
