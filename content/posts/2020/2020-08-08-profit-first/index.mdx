---
title: 'Book Summary: Profit First'
excerpt: 'The Profit First book is a step by step guide to taking a profit before paying your expenses to run an efficient and profitable business'
...
The book is based on the premise that you need to take the profit before paying expenses to grow an efficient and profitable business. This approach works for both new and existing businesses. At the end of each chapter, Mike suggests some actions that you can take to achieve a profitable business. He shares many examples of entrepreneurs who have applied the Profit First methodology scenarios and examples of how to use the system. For some of the techniques, he also gives some advanced strategies.

The book starts by giving you a way to assess your business and set up accounts to start with the Profit First Technique. It then provides a roadmap to continuously apply the profit first technique on a regular cadence. The book also shares some tips on reducing expenses, personal finance, handling layoffs and finance for kids.
...
-   Most businesses fail because of a lack of profitability.
...
-   For a tech business, actual revenue should be 2.5 times the labour cost
-   For a cheap labour field business, Real revenue should be 4 times the labour cost
-   Growth is only half the equation. It is a crucial half but still only a half
...
-   A higher (current) profit allocation percentage implies higher efficiency in running the business, which means less operating expenses. eg
...
-   Get rid of bad clients who want your least profitable products and services because you lose money.
...
-   If you have to lay off people, it is better to let 1 more person go than asking the remaining people to take a pay cut.
-   Have only 1 round of layoffs and assure the rest of the team that everyone remaining is to stay after explaining the reason for the layoff.
-   Instead of giving kids an allowance, give them a job list with corresponding pay rates that they can choose from.
