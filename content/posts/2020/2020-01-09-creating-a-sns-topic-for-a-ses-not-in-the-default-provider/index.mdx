...
excerpt:
    ...
    access SES created in a differnt region to the rest of our infratsucture.'
tags:
    - 'terraform'
    - 'devops'
    - 'aws'
...
a different region our SNS topics also need to be in that region. So how do we tell terraform to create the topics in
the ses region.
