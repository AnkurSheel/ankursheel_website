...
Like all other codingame contest, the game was turn-based, where each turn consisted of you reading the world state information from _stdin_ and outputting your action to _stdout_. This would be repeated till either only 1 bot was alive or a fixed number of rounds had passed.
...
-   **Tools from previous contests:**
    ...
    -   CGSync: A google chrome plugin that allowed me to sync a local file to the web IDE. This allowed me to work in Visual Studio which made for much faster workflow. The plugin can be found [here](https://www.codingame.com/forum/t/codingame-sync-beta/614/65).
