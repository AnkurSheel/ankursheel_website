...
This release adds support for reporting multiple assertion failures in one method in xUnit tests similar to how
[Nunit does it](https://github.com/nunit/docs/wiki/Multiple-Asserts).
