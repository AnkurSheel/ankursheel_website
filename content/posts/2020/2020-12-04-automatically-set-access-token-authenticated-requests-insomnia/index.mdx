---
title: 'How to automatically set the access token for authenticated requests in Insomnia'
excerpt: "Making your GraphQl endpoint accessible only to authorised user is a common way of securing your website. However, it does make it difficult to use Insomnia to test your requests. How do you make this lets tedious? Let's find out'"
