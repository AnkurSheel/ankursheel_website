...
excerpt: In this post, I am going to cover the third party libraries, project breakup, and current directory structure that I follow.
tags:
    - tutorial
    - game engine
---

In this post, I am going to cover the third party libraries, project breakup, and current directory structure that I follow. Even though it's not perfect, it has served me well so far
