...
Since we are going to be using DLL's to have 1 single copy of our engine code, let's understand the basics of DLL's. For those of you, who are on the fence of whether to use a DLL or not. [Here](<http://msdn.microsoft.com/en-us/library/dtba4t8b(v=VS.90).aspx>) are some of the advantages of using a dll as per MSDN
