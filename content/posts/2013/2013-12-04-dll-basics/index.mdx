...
For the project from which we want to export functions, _project_EXPORTS_ macro will be defined so that _project_API_
automatically map to _\_\_declspec(dllexport)_. For all other projects, _project_API_ will map to
