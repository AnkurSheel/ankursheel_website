...
-   Configure Apache to load the PHP module.
    ...
    -   Add the following line to _LoadModule_\_ php5*module* “[path to php5apache2_4.dl in the PHP folder]”. This would
        be something Like _"D:/Softwares/php/php5apache2_\__4.dll"_. Make sure that you use forward slashes.
