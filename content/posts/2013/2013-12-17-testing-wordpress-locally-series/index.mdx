...
excerpt: In this series, I will cover how to setup WordPress locally so that you can develop locally before pushing your blog/website on the cloud.
tags:
    - tutorial
    - Wordpress
---

In this series, I will cover how to setup WordPress locally so that you can develop locally before pushing your blog/website on the cloud. You might also want to set up WordPress locally if you are planning to develop plugins or themes, I will be covering the following aspects
