...
-   I had already participated in a previous contest at codingame which gave me a base to start from. For other postmortems click [here](http://ankursheel.com/blog/category/other/codingame/).
