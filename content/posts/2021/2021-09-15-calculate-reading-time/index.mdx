...
-   **_RoundedMinutes_** is the rounded time to make things simpler for a reader. Anything less than 30 seconds gets ignore, and anything more than 30 seconds gets rounded up to the next minute.
...
Now, we can show the estimated reading on our articles.
