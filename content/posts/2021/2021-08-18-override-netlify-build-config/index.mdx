...
As part of the [migration from Gatsby to Statiq](./migrating-gatsby-statiq), I want to keep the original site running with gatsby but deploy the new branch using statiq.
