...
As part of the [migration from Gatsby to Statiq](./migrating-gatsby-statiq), I have to rename all the files with the extension _mdx_ to _md_. Now, I could do it one by one or find a utility but using a single command is more elegant.
