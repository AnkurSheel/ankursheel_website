...
canonicalUrl: https://www.discoveriesinbookland.com/blog/building-a-storybrand/
tags:
...
_Cross posted from [Discoveries In Bookland: Building a Storybrand](https://www.discoveriesinbookland.com/blog/building-a-storybrand/)_
...
Building a Storybrand is a guide for creating effective marketing messages. The book discusses how we can use key elements that make a compelling story to stop bombarding our prospective customers with marketing noise that doesn't resonate.
...
To connect with customers, we need to have clear messaging and not generate noise. A story is the best way to combat noise because it takes random events and organises them in such a way that people are compelled to listen.
...
-   **Philosophical problem** answers the question "Why?" and gives our customers a deeper sense of meaning.
...
-   **The Need to Reach Our Potential** by inviting customers to participate in a larger movement or helping them accept themselves as they are
...
Logos of other customers that we have helped can help in providing social proof that we can help them.
...
All effective plans either clarify how somebody can do business with us, or they remove the sense of risk somebody might have about working for us.
...
If our customers might have trouble imagining how they would use our product after they buy it, we can create a post-purchase plan.

A process/post-purchase plan should have between 3 to 6 steps. If there are more than 6 steps, we should break down the steps into phases and describe the phases.
...
We can create an agreement plan by listing all the things (related to our product) our customer and then counter that list with agreements that will alleviate their fears
...
There should be very few words on our website. We should see if we can replace some of our text with images or reduce paragraphs using bullet points or summarize sentences into bite-sized soundbites. If we need a long section of text to explain something, we can place a "Read More" link at the end of the 1st or 2nd sentence so that people can expand it if they like.

<Quote quote="The key to great writing isn’t in what they say; it’s in what they don’t say" />

We should have a bold and legible one-liner so that it is the obvious statement that viewers read and invites potential customers into a story they find interesting.

There should be one obvious button to press and it should be the direct call to action. This does not mean that there should be only 1 button but rather 1 button that stands out by being a different colour (preferably brighter). This button should be placed in 2 main places on the website
...
A one-liner is a single statement that answers the question "What do you do?" and helps people realize why they need our product.
...
A one-liner needs to be tested repeatedly and is not complete till people start asking us for more information
...
They can be included everywhere so that we make it very clear what we’d like customers to do: to make a purchase so we can help them solve their problem.
...
Transitional calls to action, usually offer a customer something for free and can be used to “on-ramp” potential customers to an eventual purchase. A good transitional call to action can stake a claim to our territory and create reciprocity.

A lead generator is a resource that magnetically attracts people to our businesses and invites them to join our mailing list so that we can let them know, directly and authoritatively, how we can help them resolve their problems.
...
A lead generator should offer something more more valuable than the vague offer of a newsletter and establish us as an authority in our field. An effective lead generator has an irresistible title.
...
A nurturing campaign is a simple, regular e-mail that offers your subscribers valuable information as it relates to your products or services. The idea is to offer something of great value and then occasionally ask for an order and remind people you have products and services that can make their lives better.
...
A good way to craft each nurturing e-mail
...
About every third or fourth e-mail in a nurturing campaign should offer a product or service to the customer. This email looks a little different
...
Don't worry if the open rates on these emails are low. Even if a person sees and deletes the email, the goal has been accomplished. If someone unsubscribes, that's a good thing as they would probably never buy from you anyway and it reduces the size of your list.
...
### A template email to send to customers with the PDF/video
...
Considering this book is about marketing and crafting an effective message, it comes as no surprise that it extremely well written and is organized in a very easy to follow way. This book is not only for marketers, copywriters, but is a must-read for anyone else that wants to help people connect with their brand more effectively. It can help clarify our message, organize our thoughts and simplify our marketing.
