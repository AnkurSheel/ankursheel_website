---
published: true
slug: 'cv/professional-projects/pastry-paradise'
...
Pastry Paradise is a Match-3 game with a twist due to the possibility of making diagonal matches, using unique boosters,
unique level types and multiplayer.
...
-   Added options to hot load localization files to reduce the turn around time when fixing localization spill out
    issues.
