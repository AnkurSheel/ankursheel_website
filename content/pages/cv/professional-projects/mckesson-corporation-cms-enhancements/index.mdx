---
slug: 'cv/professional-projects/mckesson-corporation-cms-enhancements'
...
-   Analyzed the existing SQL/COBOL code so as to identify the modifications required to achieve the desired functionality.
