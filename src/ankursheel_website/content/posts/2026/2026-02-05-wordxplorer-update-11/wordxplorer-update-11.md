...
|                                       Before                                       |                                      After                                       |
|:----------------------------------------------------------------------------------:|:--------------------------------------------------------------------------------:|  
|          ![Before Splash Screen](./before_splash_screen.png){ width=200 }          |          ![After Splash Screen](./after_splash_screen.png){ width=200 }          |
| ![Before Level Selection Screen](./before_level_selection_screen.png){ width=200 } | ![After Level Selection Screen](./after_level_selection_screen.png){ width=200 } |
|            ![Before Game Screen](./before_game_screen.png){ width=200 }            |            ![After Game Screen](./after_game_screen.png){ width=200 }            |
...
|                                       Before                                       |                                        After                                         |
|:----------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------:|  
| ![Before Level Selection Screen](./before_level_selection_screen.png){ width=200 } | ![After Level Selection Screen](./body_part_level_selection_screen.png){ width=200 } |
